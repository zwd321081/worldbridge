...
const I18N = {
  ...
  "en": {
    ...
    "modifierCtrlShift": "Ctrl / Command (⌘) + Shift",
    "modifierAltShift": "Alt / Option (⌥) + Shift",
    "closeBehavior": "Popup close",
    "closeOnMouseLeave": "Close on mouse leave",
    "closeManual": "Only close with X",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "ja": {
    ...
    "modifierCtrlShift": "Ctrl / Command (⌘) + Shift",
    "modifierAltShift": "Alt / Option (⌥) + Shift",
    "closeBehavior": "ポップアップを閉じる",
    "closeOnMouseLeave": "マウスが外れたら閉じる",
    "closeManual": "X でのみ閉じる",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
    "chatModel": "チャットモデル",
    "sourceLanguage": "元の言語",
  ...
  "ko": {
    ...
    "modifierAltShift": "Alt / Option (⌥) + Shift",
    "closeBehavior": "팝업 닫기",
    "closeOnMouseLeave": "마우스가 벗어나면 닫기",
    "closeManual": "X로만 닫기",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
    "chatModel": "채팅 모델",
  ...
  "fr": {
    ...
    "modifierCtrlShift": "Ctrl / Command (⌘) + Shift",
    "modifierAltShift": "Alt / Option (⌥) + Shift",
    "closeBehavior": "Fermeture du popup",
    "closeOnMouseLeave": "Fermer à la sortie souris",
    "closeManual": "Fermer seulement avec X",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "de": {
    ...
    "modifierCtrlShift": "Ctrl / Command (⌘) + Shift",
    "modifierAltShift": "Alt / Option (⌥) + Shift",
    "closeBehavior": "Popup schließen",
    "closeOnMouseLeave": "Beim Verlassen schließen",
    "closeManual": "Nur mit X schließen",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "es": {
    ...
    "modifierCtrlShift": "Ctrl / Command (⌘) + Shift",
    "modifierAltShift": "Alt / Option (⌥) + Shift",
    "closeBehavior": "Cerrar ventana",
    "closeOnMouseLeave": "Cerrar al salir el ratón",
    "closeManual": "Cerrar solo con X",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "pt": {
    ...
    "modifierCtrlShift": "Ctrl / Command (⌘) + Shift",
    "modifierAltShift": "Alt / Option (⌥) + Shift",
    "closeBehavior": "Fechar popup",
    "closeOnMouseLeave": "Fechar ao sair o mouse",
    "closeManual": "Fechar só com X",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
    "chatModel": "Modelo de chat",
  ...
  "it": {
    ...
    "modifierCtrlShift": "Ctrl / Command (⌘) + Shift",
    "modifierAltShift": "Alt / Option (⌥) + Shift",
    "closeBehavior": "Chiusura popup",
    "closeOnMouseLeave": "Chiudi all’uscita del mouse",
    "closeManual": "Chiudi solo con X",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "ru": {
    ...
    "modifierCtrlShift": "Ctrl / Command (⌘) + Shift",
    "modifierAltShift": "Alt / Option (⌥) + Shift",
    "closeBehavior": "Закрытие окна",
    "closeOnMouseLeave": "Закрывать при уходе мыши",
    "closeManual": "Закрывать только X",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "ar": {
    ...
    "modifierCtrlShift": "Ctrl / Command (⌘) + Shift",
    "modifierAltShift": "Alt / Option (⌥) + Shift",
    "closeBehavior": "إغلاق النافذة",
    "closeOnMouseLeave": "الإغلاق عند خروج المؤشر",
    "closeManual": "الإغلاق بزر X فقط",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "hi": {
    ...
    "modifierCtrlShift": "Ctrl / Command (⌘) + Shift",
    "modifierAltShift": "Alt / Option (⌥) + Shift",
    "closeBehavior": "पॉपअप बंद करें",
    "closeOnMouseLeave": "माउस हटने पर बंद करें",
    "closeManual": "केवल X से बंद करें",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
    "chatModel": "चैट मॉडल",
  ...
  "vi": {
    ...
    "modifierCtrlShift": "Ctrl / Command (⌘) + Shift",
    "modifierAltShift": "Alt / Option (⌥) + Shift",
    "closeBehavior": "Đóng popup",
    "closeOnMouseLeave": "Đóng khi rời chuột",
    "closeManual": "Chỉ đóng bằng X",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "th": {
    ...
    "modifierCtrlShift": "Ctrl / Command (⌘) + Shift",
    "modifierAltShift": "Alt / Option (⌥) + Shift",
    "closeBehavior": "ปิดป๊อปอัป",
    "closeOnMouseLeave": "ปิดเมื่อเมาส์ออก",
    "closeManual": "ปิดด้วย X เท่านั้น",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
    "chatModel": "โมเดลแชต",
...
async function saveSettings(options = {}) {
  const settings = {
    ...
    closeBehavior: form.elements.closeBehavior.value,
