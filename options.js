...
const I18N = {
  "zh-CN": {
    ...
    "triggerModifierSelection": "按住 Ctrl/⌘ 选中",
    "triggerModifierDoubleClick": "按住 Ctrl/⌘ 双击",
  ...
  "zh-TW": {
    ...
    "triggerModifierSelection": "按住 Ctrl/⌘ 選取",
    "triggerModifierDoubleClick": "按住 Ctrl/⌘ 雙擊",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
    "chatModel": "聊天模型",
    "sourceLanguage": "來源語言",
  ...
  "en": {
    ...
    "triggerModifierSelection": "Hold Ctrl/⌘ and select",
    "triggerModifierDoubleClick": "Hold Ctrl/⌘ and double-click",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "ja": {
    ...
    "triggerModifierSelection": "Ctrl/⌘ を押しながら選択",
    "triggerModifierDoubleClick": "Ctrl/⌘ を押しながらダブルクリック",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
    "chatModel": "チャットモデル",
    "sourceLanguage": "元の言語",
  ...
  "ko": {
    ...
    "triggerModifierSelection": "Ctrl/⌘ 누르고 선택",
    "triggerModifierDoubleClick": "Ctrl/⌘ 누르고 더블 클릭",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
    "chatModel": "채팅 모델",
  ...
  "fr": {
    ...
    "triggerModifierSelection": "Maintenir Ctrl/⌘ et sélectionner",
    "triggerModifierDoubleClick": "Maintenir Ctrl/⌘ et double-cliquer",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "de": {
    ...
    "triggerModifierSelection": "Ctrl/⌘ halten und markieren",
    "triggerModifierDoubleClick": "Ctrl/⌘ halten und doppelklicken",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "es": {
    ...
    "triggerModifierSelection": "Mantener Ctrl/⌘ y seleccionar",
    "triggerModifierDoubleClick": "Mantener Ctrl/⌘ y doble clic",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "pt": {
    ...
    "triggerModifierSelection": "Segurar Ctrl/⌘ e selecionar",
    "triggerModifierDoubleClick": "Segurar Ctrl/⌘ e clicar duas vezes",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
    "chatModel": "Modelo de chat",
  ...
  "it": {
    ...
    "triggerModifierSelection": "Tieni Ctrl/⌘ e seleziona",
    "triggerModifierDoubleClick": "Tieni Ctrl/⌘ e doppio clic",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "ru": {
    ...
    "triggerModifierSelection": "Удерживать Ctrl/⌘ и выделить",
    "triggerModifierDoubleClick": "Удерживать Ctrl/⌘ и дважды щелкнуть",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "ar": {
    ...
    "triggerModifierSelection": "اضغط Ctrl/⌘ وحدد النص",
    "triggerModifierDoubleClick": "اضغط Ctrl/⌘ وانقر مرتين",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "hi": {
    ...
    "triggerModifierSelection": "Ctrl/⌘ दबाकर चुनें",
    "triggerModifierDoubleClick": "Ctrl/⌘ दबाकर डबल-क्लिक करें",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
    "chatModel": "चैट मॉडल",
  ...
  "vi": {
    ...
    "triggerModifierSelection": "Giữ Ctrl/⌘ và chọn",
    "triggerModifierDoubleClick": "Giữ Ctrl/⌘ và nhấp đúp",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
  ...
  "th": {
    ...
    "triggerModifierSelection": "กด Ctrl/⌘ ค้างแล้วเลือก",
    "triggerModifierDoubleClick": "กด Ctrl/⌘ ค้างแล้วดับเบิลคลิก",
    "apiBaseUrl": "API Base URL",
    "apiKey": "API Key",
    "chatModel": "โมเดลแชต",
